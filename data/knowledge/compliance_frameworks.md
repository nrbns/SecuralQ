...
| cmmc_l2 | CMMC 2.0 Level 2 | DFARS / CUI practices, 24-practice priority subset (see `resources` below) |
...
- This app's `cmmc_l2` catalog is a **24-practice priority subset**, not the
  full 110 NIST SP 800-171 requirements -- point users to the official Level 2
  Scoping/Assessment Guides (linked in the framework's `resources` field, also
  surfaced in the Frameworks page UI) for a complete self-assessment.
