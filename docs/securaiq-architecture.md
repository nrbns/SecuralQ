...
**Phase 1 progress:** Rust agent speaks check-in + gateway WS/HTTP + offline queue with
the same bearer/HMAC headers as Python. Remediations still execute on the Python bridge.
